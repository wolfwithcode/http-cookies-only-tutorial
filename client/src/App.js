...
const accessToken =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImFuaGxkMTExMUBnLmNvbSIsImlhdCI6MTYwODEwNzMxMCwiZXhwIjoxNjA4MTE0NTEwfQ.HfJtMGKJRkmqb-dZcsjSlxQCaRwJt2m9FqEJGSRCcGY";
const refeshToken =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImFuaGxkMTExMUBnLmNvbSIsImlhdCI6MTYwODE5MzkxOSwiZXhwIjoxNjA4MjAxMTE5fQ.BHAZnhjgzKvaVSCp8YdTS4Pe5-dQSFOTLTQtUT3-uPI";
...
function App() {
  return (
    <div className="App">
      ...
      <div className="box">
        <button className="button green" onClick={signIn}>
          signIn
        </button>
        <button className="button yellow" onClick={refeshLogin}>
          refeshLogin
        </button>
        <button className="button yellow" onClick={logOut}>
        logOut
        </button>
